            ...
            <div class="col-lg-4 col-md-5">
                <div class="blog__sidebar">
                    ...
                    <div class="blog__sidebar__item">
                        ...
                        ?>
                        <?php if (($round >=45) || $new['category_id']==14) :  continue; ?>
                ...
                <div class="row">
                    <?php if (!empty($news)): ?>
                        <?php foreach ($news AS $new):
                            ...
                            $new_link = "tin-tuc/$slug/" . $new['id'] . ".html";
                            ?>
...
<!--                                <a href="--><?php //echo $url_detail ?><!--" class="blog__btn" name="submit">Xem thêm <i class="fa fa-search-plus" aria-hidden="true"></i></a>-->
                                <a href="<?php echo $new_link ?>" class="blog__btn" name="submit">Xem thêm <i class="fa fa-search-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
