...
//        index.php?controller=&action=&page=3
  ...
  public function getPrevPage() {
    ...
    if ($current_page >= 2) {
      ...
      $prev_page = "<li><a href='$prev_url'><i class=\"fa fa-step-backward\" aria-hidden=\"true\"></i></a></li>";
    }
    return $prev_page;
  }
  ...
  public function getNextPage() {
    ...
    if ($current_page < $total_page) {
      ...
      $next_url =
        "index.php?controller=$controller&action=$action&page=$page";
      $next_page = "<li><a href='$next_url'><i class=\"fa fa-step-forward\" aria-hidden=\"true\"></i></a></li>";
    }
    return $next_page;
  }
