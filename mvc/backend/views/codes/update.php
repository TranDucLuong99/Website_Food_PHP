...
<?php if (empty($codes)): ?>
    <h2>Không tồn tại mã khuyến mại</h2>
<?php else: ?>
    <h2>Chỉnh sửa mã khuyến mại</h2>
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" name="start_day" value="<?php echo isset($_POST['start_day']) ? $_POST['start_day'] : ''; ?>"
                   class="form-control"/>
        </div>
        <div class="form-group">
            <label>Ngày hết hạn</label>
            <input type="datetime-local" name="expiration_day" value="<?php echo isset($_POST['expiration_day']) ? $_POST['expiration_day'] : ''; ?>"
                   class="form-control"/>
        </div>
        <div class="form-group">
            <?php
