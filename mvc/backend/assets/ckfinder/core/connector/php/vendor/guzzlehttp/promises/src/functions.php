 ...
 *
 * This task queue MUST be run in an event loop in orders for promises to be
 ...
 *
 * Returns an array that contains the value of each promise (in the same orders
