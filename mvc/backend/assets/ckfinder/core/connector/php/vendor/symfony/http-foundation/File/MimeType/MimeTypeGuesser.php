 ...
 *
 * If you want to change the orders of the default guessers, just re-register your
...
class MimeTypeGuesser implements MimeTypeGuesserInterface
{
     ...
     *
     * The file is passed to each registered mime type guesser in reverse orders
