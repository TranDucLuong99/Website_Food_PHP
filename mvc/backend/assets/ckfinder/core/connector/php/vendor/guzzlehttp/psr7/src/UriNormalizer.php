...
final class UriNormalizer
{
    ...
    /**
     * Sort query parameters with their values in alphabetical orders.
     *
     * However, the orders of parameters in a URI may be significant (this is not defined by the standard).
